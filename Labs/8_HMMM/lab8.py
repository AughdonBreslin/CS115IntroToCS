...
# Input: n
# Assume: n>=0
# Output: first n fibonacci sequence (0 1 1 2 3 5 8...

#r1 is the input

00 read r1       # Get input value from r1
01 jeqzn r1 13   # if r1 = 0 then jump straight to halt (line 19)
02 setn r2 0     # set r2 to 0
03 setn r3 1     # set r3 to 1
04 write r2      # write the first element, stored in r2 (0)
05 addn r1 -1    # subtract one from r1 
06 jeqzn r1 13   # now if r1 is 0, go to halt (line 19)
07 write r3      # write the second element, stored in r3 (1)
08 addn r1 -1    # subtract 1 from r1
09 jeqzn r1 13   # now if r1 is 0, go to halt (line 19)
10 add r2 r2 r3  # add contents of r2 and r3 and store them in r2
11 add r3 r2 r3  # add contents of r2 and r3 and store them in r3
12 jumpn 4       # repeat process
13 halt          # end
